...
public class ServiceBinding {
	...
	public ServiceBinding(String service_bind_id, String service_instance_id, String service_id, String plan_id,
			String app_guid, Bind_Resource bind_resource, String credentials_uri, String credentials_username,
			String credentials_password) {
		super();
	...
	public String toString() {
		return "ServiceBinding [service_bind_id=" + service_bind_id + ", service_instance_id=" + service_instance_id
				+ ", service_id=" + service_id + ", plan_id=" + plan_id + ", app_guid=" + app_guid + ", bind_resource="
				+ bind_resource + ", credentials_uri=" + credentials_uri + ", credentials_username="
				+ credentials_username + ", credentials_password=" + credentials_password + "]";
	}
