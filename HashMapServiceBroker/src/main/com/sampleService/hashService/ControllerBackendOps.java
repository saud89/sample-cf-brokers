...
public class ControllerBackendOps {
	...
	public final String servicesCatalog = "{\"services\" :[{ \"name\": "
			+ "\"HashMapService\", "
			+ "\"id\": \"bcd1696b-4058-4c06-ba31-19d9729069fc\","
			+ "\"description\": \"Hash Map service\","
			+ "\"bindable\": true,"
			+ "\"plan_updateable\": true,"
			+ "\"plans\": [{"
			+ " 		\"name\": \"HashMapPlan\","
			+ " 		\"id\": \"efe5d937-930b-4401-a94f-c6ed0eeac81d\","
			+ " 		\"description\": \"Hash Map as a service\""
			+ " 		}]"
			+ " 	}]}";
	public static final  String uri = "hashMapServiceBroker.cfapps.sapaws.hana.ondemand.com/hashService";
