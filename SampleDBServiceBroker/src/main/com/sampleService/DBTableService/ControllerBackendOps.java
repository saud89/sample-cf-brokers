...
public class ControllerBackendOps {
	...
	public final String servicesCatalog = "{ \"name\": "
			+ "\"DB-Table-Service\", "
			+ "\"id\": \"dcd9ee45-15df-49f9-9a73-2e989a98cc0c\","
			+ "\"description\": \"DB Table as service\","
			+ "\"bindable\": true,"
			+ "\"plan_updateable\": true,"
			+ "\"plans\": [{"
			+ " 		\"name\": \"DB-Table-Plan\","
			+ " 		\"id\": \"27441ea6-2c65-4fd2-9ee1-a50ea8b1cabc\","
			+ " 		\"description\": \"DB Table as a service\""
			+ " 		}]"
			+ " 	}";
	public static final  String uri = "http://localhost:8080/SampleDbServiceBroker-0.0.1-SNAPSHOT.war/tableService";
	...
	private String compareServiceBindParametersWithDB(ServiceBinding sb, ResultSet rs) {
		...
		try {
			...
			if(rs.getString("service_id") != null){
				flag = flag && rs.getString("service_id").equals(sb.getService_id());
			}
			if(rs.getString("plan_id") != null && flag){
